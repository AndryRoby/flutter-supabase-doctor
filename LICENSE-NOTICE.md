...
- Use the hosted tool at https://arling.sk/flutter-supabase-doctor/
  freely, for any purpose, personal or commercial, at no cost.
- Read the source of `index.html` / `doctor-flutter.js` to understand
...
- Use the "Flutter Supabase Doctor" name, the ARLing s. r. o. name, or
